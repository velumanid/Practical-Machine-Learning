...
training <- read.csv("C:\\Users\\s.pavankumar\\Desktop\\Prediction-Assignment-Writeup-master\\pml-training.csv", stringsAsFactors=FALSE)
...
```{r}
testing <- read.csv("C:\\Users\\s.pavankumar\\Desktop\\Prediction-Assignment-Writeup-master\\pml-testing.csv", stringsAsFactors=FALSE)
